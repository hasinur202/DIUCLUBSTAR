    ...
    <div class="row">
      <div class="col-md-5">
        <ul class="nav nav-tabs contact-list scrollbar-wrapper scrollbar-outer">
          <li class="active" v-for="user in getUsers" :key="user.id" @click="selectUser(user.id)">
          ...
          <div class="tab-pane active" id="contact-1">
            <div class="chat-body">
              <ul
                ...
                :key="message.id"
              >
                <li class="left" v-if="message.type==1">
                  <img src="images/users/user-1.jpg" alt class="profile-photo-sm pull-left" />
                  <div class="chat-item">
                ...
                <li class="right" v-if="message.type==0">
                  <img src="images/users/user-2.jpg" alt class="profile-photo-sm pull-left" />
                  <div class="chat-item">
                    <div class="chat-item-header">
                      <h5>{{ message.user.first_name }}</h5>
        ...
        <div class="send-message">
          <div class="input-group">
            ...
            <span class="input-group-btn">
              <button class="btn btn-default" @click.prevent="send()" type="button">Send</button>
            </span>
          </div>
        </div>
      </div>
